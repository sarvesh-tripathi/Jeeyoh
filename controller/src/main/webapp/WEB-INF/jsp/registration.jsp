					...
					<section id="outerForm">
						<form:form action="registerUser" commandName="userFormBean" method="POST">
							<div class="fieldsContainer">
								...
								<spring:message code="label.fullname" var="fullNameLabel"/> 
								<spring:message code="label.email.address" var="emailLabel"/> -->
								<label>
									<form:input path="firstName" tabindex="1" type="text" placeholder="${fullNameLabel}" required="required"/>
								</label>	
                                ...
                                <div class="center">
									<a href="login" id="login_href"><spring:message code="label.button.login"/></a>
