...
public class GrouponTest {
	...
	// public static GrouponService grouponService =
	// applicationContext.getBean("grouponService", GrouponService.class);

	public static void main(String[] args) {
		// getDeals();
		// getDivisions();
		// getDealsByCountry();
		testGrouponDivisionService();
	}

	public static void testGrouponDivisionService() {
	...
	/*
	 * public static void getDealsByCountry() { String country = "USA";
	 * List<Groupondivision> divisions =
	 * grouponService.getDivisionsByCountry(country); if(divisions != null) {
	 * for(Groupondivision division : divisions) { if(division != null) {
	 * ResponseModel response =
	 * grouponClient.getDealsByDivision(division.getDivisionid()); if(response
	 * != null) { List<DealsModel> deals = response.getDeals(); if(deals !=
	 * null) { System.out.println("deals size = " + deals.size()); try {
	 * ObjectMapper mapper = new ObjectMapper();
	 * System.out.println(mapper.writeValueAsString(response)); }
